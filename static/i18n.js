(() => {
  ...
  const t = {
    ...
    ,"Company linking": "ربط الشركات"
    ,"Multiple projects": "عدة مشروعات"
    ,"Combine projects": "تجميع المشاريع"
    ,"Unified project": "المشروع الموحّد"
    ,"Workspaces": "مساحات العمل"
    ,"Standard reconciliation": "المطابقة العادية"
    ,"Detailed reconciliation": "المطابقة العميقة"
    ,"Invoice tracking": "متابعة الفواتير"
    ,"Tracking dashboard": "لوحة المتابعة"
    ,"Current project": "المشروع الحالي"
    ,"Switch workflow": "تغيير المسار"
    ,"Compact view": "عرض مضغوط"
    ,"Comfortable view": "عرض مريح"
    ,"Toggle table density": "تبديل كثافة الجداول"
    ,"Public portfolio demo. Synthetic data only.": "نسخة عرض عامة ببيانات اصطناعية فقط."
    ,"Choose workspace": "اختر مساحة العمل"
    ,"Each workflow keeps its own projects, accounting logic, and reports.": "كل مسار مستقل بمشروعاته ومنطقه المحاسبي وتقاريره."
    ,"The stable reconciliation workflow with projects, source data, company identity, matching, settlements, and reports.": "مسار المطابقة المستقر بمشروعاته وبيانات المصادر وربط الشركات والمطابقة والتسويات والتقارير."
    ,"The complete workflow plus trip type, rate, hotel or pickup, trip identity, and reference matching.": "المسار الكامل مع نوع الرحلة والسعر والفندق أو نقطة الالتقاء وربط الرحلات والمطابقة المرجعية."
    ,"An independent workspace for company invoice review, payments, collection, balances, and operational follow-up.": "مساحة مستقلة لمراجعة فواتير الشركات والدفعات والتحصيلات والأرصدة والمتابعة التشغيلية."
    ,"Open projects": "فتح المشروعات"
    ,"Open tracking": "فتح المتابعة"
    ,"New project": "مشروع جديد"
    ,"New tracking project": "مشروع متابعة جديد"
    ,"System A data": "بيانات النظام أ"
    ,"System B data": "بيانات النظام ب"
    ,"Company names": "أسماء الشركات"
    ,"Trip types": "أنواع الرحلات"
    ,"Reference matching": "مطابقة الرقم المرجعي"
    ,"Comprehensive matching": "المطابقة الشاملة"
    ,"Resolution tracker": "متابعة الحل"
    ,"Company differences": "فروقات الشركات"
    ,"Settlements": "التسويات"
    ,"Delivered companies": "شركات تم تسليمها"
